...
export interface CreativeWorkspaceProtocolsProps {
...
export default function CreativeWorkspaceProtocols({
  workerCategory,
  activeProtocols = {},
...
}: CreativeWorkspaceProtocolsProps) {
  ...
  const protocolDatabase: Record<'visual' | 'audio' | 'media', ProtocolItem[]> = {
    visual: [
      { 
        ...
        desc: 'Export the final creative asset in a clean, high-quality vector format.' 
      },
      { 
        id: 'visual-2', 
